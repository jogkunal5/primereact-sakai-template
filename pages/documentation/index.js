      ...
      <div className="grid">
        <div className="col-12">
          <div className="card docs">
            ...
            <p>
              KJ is an application template for React based on the popular{" "}
              <a
              ...
              <a
                href="https://github.com/primefaces/KJ-react"
                className="font-medium hover:underline"
              >
                repository
              </a>{" "}
            ...
            <p>
              ...
              application using the KJ template.
            </p>
            ...
            <h5>Dependencies</h5>
            <p>
              Dependencies of KJ are listed below and needs to be defined at
              package.json.
            </p>
...
`}</code>
            ...
            <h5>Structure</h5>
            <p>
              KJ consist of a couple of folders where demos and core layout have
              been separated.
            </p>
...
export const LayoutProvider = (props) => {
    const [layoutConfig, setLayoutConfig] = useState({
        ...
        scale: 14                               //size of the body font size to scale the whole application
            ...
            <p>
              KJ theming is based on the PrimeReact theme being used. Default
