...
const Layout = (props) => {
  ...
  return (
    <React.Fragment>
      <Head>
        <title>KJ by PrimeReact | Free Admin Template for NextJS</title>
        <meta charSet="UTF-8" />
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="KJ by PrimeReact | Free Admin Template for NextJS"
        ></meta>
        <meta
          property="og:url"
          content="https://www.primefaces.org/KJ-react"
        ></meta>
        <meta
        ...
        <meta
          property="og:image"
          content="https://www.primefaces.org/static/social/KJ-nextjs.png"
        ></meta>
